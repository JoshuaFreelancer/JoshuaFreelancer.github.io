...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-0 z-50 flex items-center justify-center pointer-events-none transition-all duration-500 ${status.visible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
      >
        {status.visible && (
          <div
            className={`px-8 py-4 rounded-2xl shadow-2xl border backdrop-blur-md flex items-center gap-3 animate-in fade-in zoom-in duration-300 ${
              status.type === "success"
      ...
      <div className="max-w-6xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
            ...
            <button
              ...
              className={`group w-full md:w-auto px-8 py-4 font-black uppercase tracking-widest rounded-xl transition-all duration-300 flex items-center justify-center gap-2 ${
                isSubmitting
                  ...
                  : "bg-green-500 text-slate-950 hover:bg-white hover:scale-[1.02]"
              }`}
            >
        ...
        <div className="relative flex justify-center md:justify-end">
          <div className="relative w-full max-w-sm aspect-4/5 rounded-2xl overflow-hidden border border-slate-800 shadow-[0_0_50px_rgba(34,197,94,0.1)] group">
            ...
            >
              <svg
                className="w-8 h-8 mb-1 group-hover/btn:animate-bounce"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.5"
                viewBox="0 0 24 24"
