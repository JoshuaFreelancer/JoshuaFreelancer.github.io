            ...
            >
              ...
              <div className="flex flex-wrap gap-2 text-sm md:text-base">
                {item.tools.map((tool, idx) => (
                  <span
                    key={idx}
                    className="text-green-500 font-medium tracking-wide"
                  >
                    {tool}{" "}
          ...
          >
            ...
            <div className="p-8 md:w-1/2 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 text-xs font-bold text-green-400 bg-green-900/20 rounded-full border border-green-900/30"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className={`md:w-1/2 ${project.imageColor} relative group`}>
              ...
              <div className="absolute inset-0 bg-slate-950/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                <a
                  href="#"
                  className="px-6 py-2 bg-white text-slate-950 font-bold rounded-full hover:scale-105 transition-transform"
                >
                  Ver Proyecto
                </a>
              </div>
